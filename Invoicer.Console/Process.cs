    ...
    public class Process
    {
        public void Go()
        {
            new InvoicerApi(SizeOption.A4, OrientationOption.Portrait, "£")
                .TextColor("#CC0000")
                .BackColor("#FFD6CC")
                .Image(@"Invoicer.Console\images\vodafone.jpg", 125, 27)
                ...
                .Items(new List<ItemRow> { 
                    ...
                    ItemRow.Make("24 Months (£22.50pm)", "100 minutes, Unlimited texts, 100 MB data 3G plan with 3GB of UK Wi-Fi", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "100 minutes, Unlimited texts, 100 MB data 3G plan with 3GB of UK Wi-Fi", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "Java หลบไป Kotlin น้องใหม่กำลังมา", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "Java หลบไป Kotlin น้องใหม่กำลังมา", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "Java หลบไป Kotlin น้องใหม่กำลังมา", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "Java หลบไป Kotlin น้องใหม่กำลังมา", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
                    ItemRow.Make("24 Months (£22.50pm)", "Java หลบไป Kotlin น้องใหม่กำลังมา", (decimal)1, 20, (decimal)360.00, (decimal)432.00),
